...
const tags = {
    ...
    web: { name: "Web", backgroundColor: "#705C53" },
    nlp: { name: "NLP", backgroundColor: "mediumseagreen" },
    llm: { name: "LLM", backgroundColor: "#6ca496" },
    ml: { name: "Machine Learning", backgroundColor: "peru" },
    js: { name: "JavaScript", backgroundColor: "#f0db4f" },
    css: { name: "CSS", backgroundColor: "#29a9df" },
    c: { name: "C", backgroundColor: "#A8B9CC" },
    cv: { name: "Computer Vision", backgroundColor: "#E6E6FA" },
    ip: { name: "Image Processing", backgroundColor: "navajowhite" },
    cloud: { name: "Cloud Computing", backgroundColor: "#0041c3;" },
    sw: { name: "Semantic Web", backgroundColor: "blueviolet" },
    python: { name: "Python", backgroundColor: "#ffc42d" },
    php: { name: "PHP", backgroundColor: "#787CB5" },
    svelte: { name: "Svelte", backgroundColor: "#ff3e00" },
    ts: { name: "TypeScript", backgroundColor: "#3178c6" },
...
const webProjects = [
    ...
    // },
    {
        ...
        tags: [{ name: "TS, Game Logic, DOM Manipulation", backgroundColor: "#3178c6" }],
